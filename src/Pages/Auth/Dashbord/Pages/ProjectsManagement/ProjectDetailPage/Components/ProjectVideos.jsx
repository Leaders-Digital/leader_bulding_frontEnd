...
import AddVideoForm from "../../../../../../../Forms/ProjectForms/projectVideos/AddVideoForm.jsx";
import UpdateVideoForm from "../../../../../../../Forms/ProjectForms/projectVideos/UpdateVideoForm.jsx";
            ...
            <>
                <div className={'mt-12'}>
                    <div className="w-full h-14 border-b-2 border-b-[#DBDCDE] mb-4 flex justify-between items-center">
                        <span
                            className="font-jakarta text-xl font-bold text-[#3A3541] ml-3">Les vidéos du chantier</span>
                        <Button
                            icon={<PlusOutlined/>}
