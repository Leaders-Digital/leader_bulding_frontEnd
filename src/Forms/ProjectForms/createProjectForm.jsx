...
const CreateProjectForm = ({handleCancel}) => {
    ...
    <div  className='h-full max-h-[43rem]'>
        <FormProvider {...methods}>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                Budget
                        ...
                        name='budget'
                        control={control}
                        render={({field})=>(<Input {...field} suffix="TND"    className='h-12 w-full' type='Number'  />)}
     ...
     <label htmlFor="" className=' font-jakarta   font-bold size-1  my-5 text-[#3A3541] w-full '>Status</label>
        <Controller
                name='status'
                control={control}
                render={({field})=>(<Select {...field} options={projstatus} className='h-12 w-full' />)}
                />
     </div>
     ...
     <div className='flex flex-col gap-2 px-2'>
                ...
                />
                     ...
                     <div className='flex flex-col gap-2'>
                      <div className='flex flex-col gap-3'>   <InputField
                      name="location"
                      label="Adresse total"
                      placeholder="Adress total"
                      required="Adress total est obligatoire"
                      className="h-12 w-full rounded-lg bg-[#F4F5F9] p-4"
                      />
                      <div className='flex flex-row justify-end'>
                        <Button color='default'  variant="solid"  onClick={getCurrentPosition} >
                          Optenir l'emplacement actuel
                        </Button>
                      </div>
                      <div className='flex flex-row justify-end'>
                        <button
                        ...
                        >
                            <span className='font-jakarta font-bold size-3 text-[#3A3541] group-hover:text-black'>
                                créer
                            </span>
                        </button>
                    </div>
