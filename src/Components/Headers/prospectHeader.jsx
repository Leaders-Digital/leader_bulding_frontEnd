...
const ProspectHeader = () => {
    ...
    const items = [{
        key: "1",
        label: "Profil",
        icon: <Icon icon="hugeicons:user-circle" width="24" height="24" style={{color: " #0d0a01"}}/>,
        onClick: profileUser
    }]
    ...
    return (
        <div className='w-[94rem] h-16 bg-white rounded-2xl mr-3 justify-between flex flex-row'>
            ...
            <div className=' w-[20rem] flex flex-row h-full  justify-end items-center gap-3 mr-4'>
                ...
                <button><Icon icon="hugeicons:notification-02" width="30" height="30" style={{color: '#F7D47A'}}/>
                </button>
                <button onClick={handleLogout}><Icon icon="hugeicons:logout-square-02" width="30" height="30"
                                                       style={{color: ' #ff3434'}}/></button>
            </div>
        </div>
    )
}
